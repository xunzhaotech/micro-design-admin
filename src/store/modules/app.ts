...
const app = {
  ...
  mutations: {
    ...
    //   },
    //   [TOGGLE_FIXED_SIDEBAR]: (state:any, mode) => {
    //     state.fixedSidebar = mode
    //     storage.set(TOGGLE_FIXED_SIDEBAR, mode:any)
    //   },
    //   [TOGGLE_CONTENT_WIDTH]: (state:any, type) => {
    //     state.contentWidth = type
    //     storage.set(TOGGLE_CONTENT_WIDTH, type)
    //   },
    //   [TOGGLE_HIDE_HEADER]: (state:any, type) => {
    //     state.autoHideHeader = type
    //     storage.set(TOGGLE_HIDE_HEADER, type)
    //   },
    //   [TOGGLE_COLOR]: (state:any, color) => {
    //     state.color = color
    //     storage.set(TOGGLE_COLOR, color)
    //   },
    //   [TOGGLE_WEAK]: (state:any, mode) => {
    //     state.weak = mode
    //     storage.set(TOGGLE_WEAK, mode)
    //   },
    //   [APP_LANGUAGE]: (state:any, lang, antd = {}) => {
    //     state.lang = lang
    //     state._antLocale = antd
    //     storage.set(APP_LANGUAGE, lang)
    //   },
    //   [TOGGLE_MULTI_TAB]: (state:any, bool) => {
